...
define(['durandal/app', 'durandal/system', 'durandal/viewLocator', 'durandal/binder', 'dataContext'], function(app, system, viewLocator, binder, dataContext) {
  //enable debug
  system.debug(true);
  ...
  app.start().then(function() {
    ...
    dataContext.initialize(function() {
      /**
